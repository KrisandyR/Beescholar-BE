...
class ActivitySceneSeeder4 extends Seeder
{
    ...
    public function createDialogueFlow(string $activityId)
    {
        ...
        $scene1 = $this->createScene($activityId, 'band_room_empty.png', true, false);
        ...
        $scene2 = $this->createScene($activityId, 'band_room_empty.png');
        ...
        // Scene 3: Ehan Reacts
        $scene3 = $this->createScene($activityId, 'band_room_empty.png');
        ...
        $scene4 = $this->createScene($activityId, 'band_room_empty.png');
        ...
        $scene5 = $this->createScene($activityId, 'band_room_empty.png');
        ...
        $scene5a = $this->createScene($activityId, 'band_room_empty.png');
        $dialogue5a = $this->createDialogue('Alright, I’ll give it a try.', $mcCharacterId);
        $scene5a->sceneable()->associate($dialogue5a);
        $scene5a->save();

        $scene6a = $this->createScene($activityId, 'band_room_empty.png');
        ...
        $scene7 = $this->createScene($activityId, 'band_room_empty.png');
        ...
        $scene8 = $this->createScene($activityId, 'band_room_empty.png');
        ...
        // Tutorial Trigger
        $scene9 = $this->createScene($activityId, 'band_room_empty.png');
        $event9 = Event::create([
        ...
        // Minigame Trigger
        $scene10 = $this->createScene($activityId, 'band_room_empty.png');
        ...
        $scene11 = $this->createScene($activityId, 'band_room_empty.png');
        ...
        $scene12 = $this->createScene($activityId, 'band_room_empty.png');
        ...
        $scene13 = $this->createScene($activityId, 'band_room_empty.png');
        ...
        $scene14 = $this->createScene($activityId, 'band_room_empty.png');
        ...
        $scene15 = $this->createScene($activityId, 'band_room_empty.png', false, true);
